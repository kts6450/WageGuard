...
| 핵심 가치 | E9 근로자 **66%가 자신의 계약 내용을 모르는** 구조 — 신고할 수 없는 피해자를 국가가 **먼저 찾아가도록** 점검 우선순위를 데이터로 제안 |
...
- **E9(비전문취업) 비자 근로자의 약 66%가 자신의 근로계약 내용을 인지하지 못한다**(통계청 이민자체류실태조사). 계약을 모르는 사람은 위반도 인식하지 못하고, 인식하지 못하면 신고도 하지 않는다. 이것이 이주노동자 임금 착취 **신고율이 5% 미만**에 그치는 구조적 이유다.
- 국내 이주노동자는 약 **90만 명**(고용노동부, 2024)이며, 제조·농축산·건설·돌봄 영역에 집중되어 있다. 임금 체불·삭감·과도한 공제·초과근무 미지급 등 착취형 위반은 광범위하게 발생하지만 피해자가 신고에 도달하지 못하는 이유는 다음과 같다.
